...
const Test = () => {
  return (
    ...
    >
      <defs>
        <style>
          {`.cls-1{fill:#fff;}`}.{`cls-2{fill:aqua;}`}
        </style>
      </defs>
